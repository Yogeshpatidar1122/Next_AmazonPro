import { getProducts } from "@/app/helpers/index";
  ...
  return (
    <Container className="flex items-center flex-col md:flex-row px-4 xl:px-0">
      ...
      <div className="w-full md:w-1/2 flex flex-col gap-2">
        ...
        <button className="bg-yellow-400/80 text-zinc-700 px-6 py-2 font-medium rounded-md hover:bg-yellow-400 hover:text-black cursor-pointer duration-200 hover:shadow-lg w-40 my-2">
          add to cart
        </button>
        {product?.isNew && (
          <p className="text-yellow-400 font-semibold">New Arrival</p>
        )}
        <p>
